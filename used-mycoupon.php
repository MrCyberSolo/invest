...
<div class="col-12 bg-white">
    <div class="header-button">
      <a href="mycoupon.php" >Unused</a>
      <a href="used-mycoupon.php" class="active">Used</a>
...
<div class="col-12">
       <?php 
        $i=1;
        $query = mysqli_query($con,"select * from capping_request where cr_status='Approved' AND cr_userid='$userid_access' order by cr_id desc");
