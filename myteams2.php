  ...
  <div class="row appBody" >
    <div class="col-12 percent-section">
        ...
        <div class="totalBox tab d-flex justify-content-between text-center">
            ...
            <a href="myteams2.php" type="button" class="teamlink inner active" onclick="openteam(event, 'second')" >
                <p>C-5% (<?php 
								$total_count=0;
                                foreach($levels as $level) 
                                {
            ...
            <a href="myteams3.php" type="button" class="teamlink inner" onclick="openteam(event, 'third')">
                <p>D-2% (<?php 
								$total_count=0;
                                foreach($levels as $level) 
                                {
