...
<div class="col-12 bg-white">
    <div class="header-button">
      ...
      <a href="expired.php" class="active">Expired</a>
    </div>
</div>
...
<div class="col-12">
       <?php 
        $i=1;
        $query = mysqli_query($con,"select * from capping_request where cr_status='Deactive' AND cr_userid='$userid_access' order by cr_id desc");
