...
function spin() {
  ...
  if (MagicRoaster.includes(Hasil[0])) SelectedItem = "2";
  if (Sepeda.includes(Hasil[0])) SelectedItem = "3";
  if (RiceCooker.includes(Hasil[0])) SelectedItem = "4";
  if (LunchBox.includes(Hasil[0])) SelectedItem = "5";
  if (Sanken.includes(Hasil[0])) SelectedItem = "6";
  if (Electrolux.includes(Hasil[0])) SelectedItem = "8";
  if (JblSpeaker.includes(Hasil[0])) SelectedItem = "1";
  ...
  setTimeout(function () {
    applause.play();
    swal(
      "Lucky Number " + SelectedItem +"",
      "Wining Chance " + SelectedItem + ".",
      "success"
    );
  }, 5500);
