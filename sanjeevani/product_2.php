...
<div class="appCapsule container">
    <header class="mt-3">
        ...
        <div class="headerTab d-flex justify-content-around">
          <a href="product.php" >Cheetos</a>
          <a href="product_2.php" class="active"><i class="bi bi-gear-fill"></i>LAY'S</a>
        </div>
...
<?php
      $i=0;
    $result = mysqli_query($con,"SELECT * FROM `package` WHERE `status`='Active' AND `pa_type`='User 2'"); 
